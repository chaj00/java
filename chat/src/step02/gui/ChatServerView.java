		...
		Thread connectThread = new Thread(new Runnable(){
			...
			public void run() {
				try {
					...
					//********1. 클라이언트와 통신할 수 있는 스트림을 생성
					//********2. 클라이언트가 보낸 데이터 읽기
					//********3. 서버의 JTextArea에 정보를 출력
					//********4. 클라이언트쪽으로 "환영합니다."메세지를 보내기
					//********5. ClinetCharView에서 서버가 보낸 데이터를 읽어서 
					//           Client의 JtextArea에 출력하는 작업을 추가 
					...
					taclientlist.append(recvMsg+"님이 입장....\n");
					sendMsg ="환영합니다.";
					out.println(sendMsg);
